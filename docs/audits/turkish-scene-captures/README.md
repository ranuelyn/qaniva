...
| 07-simulation-default.png | Simülasyon (varsayılan) | **İkinci geçiş sahnesi:** ayak ucundan, ortalanmış ve yükseltilmiş kamera; kollar yanda yatakta, eller gevşek, yarı oturur hasta (**sahip tarafından sağlanan 'Hospital Patient' modeli**: dokulu yüz/cilt, gerçek önlük, bileklik; Blender'da rig'lenip pozlandı); izleyiciye dönük monitör (EKG dalga şeridi + NABIZ yeşil / SpO2 camgöbeği / TA kırmızı / SS sarı); **kenar raylı kategori sekmeleri** (sol: Hasta · Muayene, sağ: İstemler · Tedavi · Diğer) ve altta yüzen Vaka günlüğü / Çık |
